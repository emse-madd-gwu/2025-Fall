...
Download and unzip the [demo choice-based conjoint survey](https://github.com/surveydown-dev/template_conjoint_buttons/archive/refs/heads/main.zip) for your pilot survey. The folder contains the following files:
...
- You may directly copy and paste any content you wish from your [Survey Plan](https://madd.seas.gwu.edu/2025-Fall/project/2-survey-plan.html) assignment.
