...
## `r fa('globe')` Course website: https://madd.seas.gwu.edu/2025-Fall/

--

## `r fa('slack')` Course slack: https://emse-madd-f25.slack.com

--

## `r fa('r-project')` & RStudio: [Course Software Page](https://madd.seas.gwu.edu/2025-Fall/software.html)
...
### Take [this self assessment](https://madd.seas.gwu.edu/2025-Fall/self-assessment.html)
...
## `r fa('clock')` Due 11:59pm Monday before class
...
# [Semester Project](https://madd.seas.gwu.edu/2025-Fall/project/0-overview.html) (45% of grade)
...
<center>
<img src="https://madd.seas.gwu.edu/2025-Fall/figs/grade-breakdown-1.png" width=90%>
</center>
...
## .center[The **wrong** ways to use LLMs]
...
## .center[The **right** way to use LLMs]
...
## `r fa('slack')` Use [Slack](https://emse-madd-f25.slack.com/) to ask questions.
...
1. If you haven't already, install everything on the [software page](https://madd.seas.gwu.edu/2025-Fall/software.html)
...
## If you haven't yet, install [these packages](https://raw.githubusercontent.com/emse-madd-gwu/2025-Fall/main/content/packages.R)
