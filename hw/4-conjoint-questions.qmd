...
Once you have an understanding of how things are working, try downloading the [template](https://surveydown.org/templates/conjoint_buttons) on how to implement a conjoint survey using the button format discussed in the blog. You should be able to use that template to re-create a working survey where the choice questions are shown randomly according to the design of experiment in the template.
